...
if (isset($_POST['nomfilm']) && isset($_POST['anneereal']) &&
    isset($_POST['synopsis']) && isset($_POST['nomgenre']) &&
    isset($_POST['nomreal']) && isset($_POST['urlaffiche'])) {
    $films->insertFilm($_POST['nomfilm'], $_POST['anneereal'], $_POST['synopsis'], $_POST['nomgenre'], $_POST['nomreal'], $_POST['urlaffiche']);
}
